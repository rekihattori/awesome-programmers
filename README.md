...
- [Doug Cutting](https://en.wikipedia.org/wiki/Doug_Cutting): The creator of the BigTable inspired, de-facto "big data" distributed file system and processing framework [Hadoop](https://en.wikipedia.org/wiki/Apache_Hadoop).
...
- [Doug Cutting](https://en.wikipedia.org/wiki/Doug_Cutting): The creator of the data search library [Lucene](https://en.wikipedia.org/wiki/Lucene) and the highly scalable web crawler [Nutch](https://en.wikipedia.org/wiki/Apache_Nutch).
