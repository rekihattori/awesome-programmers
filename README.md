...
- [Charles W. Bachman](https://en.wikipedia.org/wiki/Charles_Bachman): The designer of Integrated Data Store, known to be one of the first database management systems now categorized as a navigational database.
